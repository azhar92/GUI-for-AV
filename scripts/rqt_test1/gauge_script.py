...
# The first gauge
process = subprocess.Popen(['rqt', '--command-start-plugin', 'rqt_test1'])
process.wait()

# Parameters for the first gauge
process = subprocess.Popen(['rosparam', 'set', '/rqt_test1/topic1', '/pitch'])
process = subprocess.Popen(['rosparam', 'set', '/rqt_test1/gauge_name1', 'Pitch'])
...
process = subprocess.Popen(['rosparam', 'set', '/rqt_test1/topic2', '/yaw'])
process = subprocess.Popen(['rosparam', 'set', '/rqt_test1/gauge_name2', 'Yaw'])
